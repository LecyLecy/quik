...
export default function RealWhatsAppLinkPage({ onLinked }: RealWhatsAppLinkPageProps) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 p-4">
      <div className="max-w-md mx-auto pt-16">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Connect to WhatsApp</h1>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
            {status.isConnecting && !status.hasQR && (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">Starting WhatsApp connection...</p>
              </div>
            )}
